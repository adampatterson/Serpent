					...
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input type="email" class="input-xlarge" id="email" name="email" required value="<?= $user->email ?>">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="input-xlarge" id="username" name="username" required value="<?= $user->username ?>">
							</div>
						</div>
						<div class="control-group">
